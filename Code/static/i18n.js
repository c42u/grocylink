...
const I18N = {
  de: {
    ...
    'prod.hint': 'Individuelle Einstellungen pro Produkt. Warntage: 0 = keine Benachrichtigungen, leer = Standardwert. Wiederholung: 0 = immer, leer = globaler Standard. Per-Produkt-Einstellungen haben Vorrang vor Kategorie- und Lagerort-Filtern.',
    'prod.th_product': 'Produkt',
    'prod.th_stock': 'Bestand',
    'prod.th_expiry': 'Ablaufdatum',
    'prod.th_warn_days': 'Warntage',
    'prod.th_repeat': 'Wiederholung',
    'prod.th_action': 'Aktion',
    'prod.placeholder': 'Standard',
    'prod.repeat_ph': '0=immer',
    'prod.reset': 'Reset',
  ...
  en: {
    ...
    'prod.hint': 'Individual settings per product. Warning days: 0 = no notifications, empty = global default. Repeat: 0 = always, empty = global setting. Per-product settings override category and location filters.',
    'prod.th_product': 'Product',
    'prod.th_stock': 'Stock',
    'prod.th_expiry': 'Expiry date',
    'prod.th_warn_days': 'Warning days',
    'prod.th_repeat': 'Repeat',
    'prod.th_action': 'Action',
    'prod.placeholder': 'Default',
    'prod.repeat_ph': '0=always',
    'prod.reset': 'Reset',
